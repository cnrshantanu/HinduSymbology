...
public class DataBaseHelper extends SQLiteOpenHelper{
    ...
    private static String DB_NAME = "Gods.db";
  ...
  /**
    ...
    public List<God_Bean> getAllGodNames() {
        ...
        // Select All Query
        String selectQuery = "SELECT * FROM Gods;" ;
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                dao.setMarker_Image(cursor.getString(0));
                dao.setMain_Image(cursor.getString(1));
                dao.setSummary(cursor.getString(2));
                dao.setSymbology(cursor.getString(3));
                dao.set_id(cursor.getString(4));
                dao.setGod_Name(cursor.getString(5));
                dao.setClassification(cursor.getString(6));
