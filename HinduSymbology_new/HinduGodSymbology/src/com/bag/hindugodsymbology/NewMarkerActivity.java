...
//       configureButtons();
	...
	private void configureButtons(){
		...
		while (iter.hasNext())//iterating through the hashmap 
		{
			...
			b = new Button(this);
			params.width  = params.height = 10;
			params.leftMargin = m_GodPicture.getLeft() + (int)(0.5f * m_GodPicture.getWidth()) - params.width/2;//i've put x in place of imageleft
			params.topMargin  = m_GodPicture.getTop()  + (int)(0.5f * m_GodPicture.getHeight()) - params.height/2;//i've put y in place of image top
